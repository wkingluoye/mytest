...
import util.ChatMsgEntity;
import util.ChatMsgViewAdapter;
import util.SoundMeter;
...
public class eightActivity extends Activity {
	...
	private RelativeLayout sc_img1;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		requestWindowFeature(Window.FEATURE_NO_TITLE); // ����ʾ�ǳ���ı�����
	...
	public void initView() {
		...
		img1 = (RelativeLayout) this.findViewById(R.id.voice_rcd_hint_anim_area);
		del_re = (RelativeLayout) this.findViewById(R.id.sc_img1);
		//del_re = (ImageView) this.findViewById(R.id.voice_rcd_hint_cancel_icon_small);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		if (btn_vocie) {
			...
			System.out.println("voicechatIv:"+btn_rc_X+"|"+btn_rc_Y+",del_re:"+del_x+"|"+del_Y+",event:"+event.getX()+"|"+event.getY());
			...
			if (event.getY() < btn_rc_Y) {//���ư��µ�λ�ò�������¼�ư�ť�ķ�Χ��
				...
				//Animation mLitteAnimation = AnimationUtils.loadAnimation(this, R.anim.voice_from_icon_anim);
				//Animation mBigAnimation = AnimationUtils.loadAnimation(this, R.anim.voice_to_icon_anim);
